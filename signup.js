...
async function signup(event) {
    ...
    var checkUser = await db.query(queryBuilder.checkIfUserExist(),[username]);
    ...
    var result = await db.query(queryBuilder.createUser(), [first_name, last_name, username,hash, balance,token]);
